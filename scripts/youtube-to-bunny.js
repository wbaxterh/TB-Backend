...
const BUNNY_LIBRARY_API_KEY = process.env.BUNNY_LIBRARY_API_KEY || '5be583ed-202a-4107-8743c71fef1f-7116-4795';
...
async function main() {
    ...
    try {
        ...
        const videoInfo = JSON.parse(execSync(
        ...
        console.log(`⏱️  Duration: ${Math.floor(videoInfo.duration / 60)}:${String(videoInfo.duration % 60).padStart(2, '0')}`);
        console.log('');
